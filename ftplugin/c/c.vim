"setlocal cindent cino=:0,l1,g0,c3,(0,)100,*100
"setlocal expandtab shiftwidth=2 tabstop=2 textwidth=100

map #p vip:!par w78
map #rb :set noexpandtab:set sw=8:set ts=8

map! <C-l> /* Copyright (C) 2012 Oliver Lemke<CR><CR>
      ...
      \along with this program.  If not, see <http://www.gnu.org/licenses/>.<CR><CR>
      \<BS>/<CR><CR>
