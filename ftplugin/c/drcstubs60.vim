...
"
"  Changed By:  Oliver Lemke  <olemke@core-dump.net>
"  Changes:     Adapted to match the GNU Coding Style
"  Last Change: 2001-12-05 
"
"  Usage:
"
...
function! <SID>DrChipCStubs()
 ...
 if     wrd == "if"
  exe "norm! bdWaif ()\<CR>{\<CR>}\<Esc>$k$kF("
 elseif wrd == "i"
  exe "norm! xaif ()\<CR>{\<CR>}\<Esc>$k$kF("
 ...
 elseif wrd == "case"
  exe "norm! bdWacase x:\<CR>break;\<Esc>khf:hcl"
 elseif wrd == "c"
  exe "norm! xacase x:\<CR>break;\<Esc>khf:hcl"
 ...
 elseif wrd == "do"
  exe "norm! bdWado\<CR>{\<CR>}\<CR>while ();\<Esc>kO \<c-h>\<Esc>"
